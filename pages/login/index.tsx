        ...
        <DefaultLayout>
            <section className="flex items-center justify-center">
                <Card className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 py-8 flex w-5/6 max-w-lg flex-col gap-4 rounded-large">
                    <CardBody>
                        <p className="text-2xl font-medium text-center">{t("title")}</p>
                        ...
                        <Form className="px-4 py-12 items-center justify-centerflex flex-col gap-3" validationBehavior="native">
                            <Input isClearable  type="email" label={t("email")}/><br />
                            <Input
                                label={t("password")}
                                endContent={
                        ...
                        <p className="text-center text-small">
                            {t("createnew")}&nbsp;
                            <Link className="text-small" color="primary" href={"/register"}>
                                {t("signup")}
                            </Link>
                        </p>
                    </CardBody>
